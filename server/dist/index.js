...
const clientNotifications_js_1 = require("./routes/clientNotifications.js");
const clientWebhooks_js_1 = require("./routes/clientWebhooks.js");
...
app.use('/api/v1/client/notifications', clientNotifications_js_1.clientNotificationsRouter);
app.use('/api/v1/client/webhooks', clientWebhooks_js_1.clientWebhooksRouter);
...
app.use('/api/v1/quotes', quotes_js_1.quotesRouter);
