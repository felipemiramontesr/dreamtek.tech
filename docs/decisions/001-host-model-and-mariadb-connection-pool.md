...
- **Status**: Superseded by ADR 005 (Node.js TypeScript Express API Server on `apiv1.dreamtek.tech`)
- **Date**: 2026-07-25 (Superseded 2026-07-31)
- **Deciders**: Alfa (O/architect), Charlie (O/fullstack), Bravo (R), GrayMan (L)
- **FC Reference**: `protocols/fc/001a_FC_DB_Schema_and_Host_Model.md` (Superseded by `protocols/fc/001g_FC_Dead_Code_Cleanup.md`)

---

## 1. Context & Problem Statement

_Dreamtek.tech_ operates a high-speed landing page built with Next.js 16 (React 19) compiled as a static HTML export (`output: 'export'`) for optimal CDN performance.
