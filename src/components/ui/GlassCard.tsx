...
export const GlassCard = React.forwardRef<HTMLDivElement, GlassCardProps>(
  ({ className = '', featured = false, children, ...props }, ref) => {
    ...
    const baseClasses = "glass-panel glass-panel-hover p-8 rounded-2xl flex flex-col relative overflow-hidden group";
    ...
    return (
      <div 
        ref={ref}
        className={`${baseClasses} ${featuredClasses} ${className}`.trim()}
        {...props}
      >
