...
export function getApiBaseUrl(envUrl?: string, hostname?: string): string {
  const resolvedEnv = envUrl ?? process.env.NEXT_PUBLIC_API_BASE_URL;
  ...
  return 'https://apiv1.dreamtek.tech/api/v1';
}
