export const en = {
    ...
    plans: [
      {
        ...
        features: [
          ...
          'Active escort with 3 monthly hours of engineering support for quick changes.',
        ],
        ctaText: 'View Scope & Details',
      },
      {
        id: 'archon-fleet',
        badge: '',
      ...
      },
      {
        ...
        features: [
          'Pentesting specialized (Black/Gray Box)',
  ...
  contact: {
    ...
    form: {
      ...
      options: {
        starterkit: 'Digital Escort — StarterKit',
