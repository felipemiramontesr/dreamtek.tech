export const en = {
  ...
  auth: {
    ...
    switchToRegister: "Don't have an account yet? Register here",
    ...
    mfaSubtitle: 'Enter the code to verify your identity',
    mfaMethodTotp: 'Google Authenticator',
    mfaMethodEmail: 'Email Code',
    mfaMethodRecovery: 'Recovery Code',
    mfaCodePlaceholder: '6-digit code',
    mfaRecoveryPlaceholder: 'XXXXX-XXXXX',
    mfaVerifySubmit: 'Verify & Proceed',
    mfaSendEmailBtn: 'Send code to my email',
    mfaEmailSent: 'Code sent to your email.',
