export const es = {
  ...
  auth: {
    ...
    switchToRegister: '¿No tienes cuenta aún? Regístrate aquí',
    switchToLogin: '¿Ya tienes una cuenta? Inicia sesión aquí',
    passwordsMismatch: 'Las contraseñas no coinciden.',
    fillAllFields: 'Por favor completa todos los campos requeridos.',
    mfaTitle: 'Verificación en Dos Pasos',
    mfaSubtitle: 'Introduce el código para verificar tu identidad',
    mfaMethodTotp: 'Google Authenticator',
    mfaMethodEmail: 'Código por Correo',
    mfaMethodRecovery: 'Código de Recuperación',
    mfaCodePlaceholder: 'Código de 6 dígitos',
    mfaRecoveryPlaceholder: 'XXXXX-XXXXX',
    mfaVerifySubmit: 'Verificar y Acceder',
    mfaSendEmailBtn: 'Enviar código a mi correo',
    mfaEmailSent: 'Código enviado a tu correo.',
    mfaBackToLogin: 'Volver a inicio de sesión',
  },
  services: {
    heading1: 'Servicios ',
    heading2: 'Core',
